...
<html ng-app="exampleApp" >
	<head>
	    <title>AngularJS Chapter9-16</title>
	    ...
	    <script type="text/javascript" src="/resources/angularjs/controllers/chapter9-16Controller.js"></script>
	    <script type="text/javascript" src="/resources/angularjs/filters/filters.js"></script>
	</head>
	<body>
	    <div class="panel">
