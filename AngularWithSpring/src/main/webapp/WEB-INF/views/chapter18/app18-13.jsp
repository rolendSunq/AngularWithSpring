...
<html lang="ko" ng-app="exampleApp">
	<head>
		...
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/services/customServicesByProviderUpdate.js"></script>
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/directive/chapter18-5Directive.js"></script>
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/controllers/chapter18-13Controller.js"></script>
