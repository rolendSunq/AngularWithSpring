...
<html lang="ko" ng-app="exampleApp">
	<head>
		...
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/controllers/chapter23-2ProductController.js"></script>
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/directive/chapter23-2IncrementDirective.js"></script>
