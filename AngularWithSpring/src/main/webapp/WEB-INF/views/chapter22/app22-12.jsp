...
<html lang="ko" ng-app="exampleApp">
	<head>
		...
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/controllers/chapter22-12Controller.js"></script>
		...
		<title>Chapter 22-12</title>
	</head>
	<body ng-controller="defaultCtrl">
		<div class="panel panel-primary">
			<h3 class="panel-heading">Products</h3>
			<ng-include src="'template/tableView3'" ng-show="displayMode == 'list'"></ng-include>
