...
<html lang="ko" ng-app="exampleApp">
	<head>
		...
		<script type="text/javascript" src="<c:out value="${myContextPath}"/>/resources/angularjs/controllers/chapter19-15Controller.js"></script>
		...
		<title>Chapter 19-15 DOM API Services</title>
	</head>
	<body ng-controller="defaultCtrl">
		<div class="well">
			<p><input class="form-control" ng-model="htmlData" /></p>
			<p ng-bind-html="deliberatelyTrustDangerousSnippet()"></p>
		</div>
	</body>
</html>